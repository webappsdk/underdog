...
PH.wrappedRun=function(a,b,c,d){PH.fire(a.id+"-before",b,function(b){(new Promise(function(d,h){PH.fire(a.id+"-in-process",b);var g=CH.cache(PH.CACHED_CONFIGURATIONS_ID)[a.id];U.un(g)&&(g={});try{var k=a.run(b,g,c);d(k)}catch(l){h("error_plugin_execution.")}})).then(function(a){U.un(d)||d(a)},function(a){U.un(d)||d({success:!1,message:a})})["finally"](function(){PH.fire(a.id+"-after",b)})})};PH.getResourcePath=function(a){return PH.root+"/"+a["package"]+"/client/resources/"};function EM(){}
EM.editors={};EM.activeEditor=null;EM.popup=null;EM.popupBody=null;EM.field=null;EM.load=function(a,b){EM.field=b;U.un(EM.editors[a])?U.loadjs("/editor/"+a+".js"):EM.render(EM.editors[a])};EM.add=function(a,b){null!=b&&(EM.field=b);EM.editors[a.id]=a;EM.render(a)};
