...
g={}):(delete c[f],delete g[f])}}}(),PH=function(){function c(a){var b=a.split(".");if(1<b.length){a={id:a,"package":b[0]};for(var d="",e=1;e<b.length;e++)d+=b[e],e<b.length-1&&(d+="/");a.pluginPath=d;return a}return null}function g(a,b,d,e){if(null==b||"eager"!=b&&"lazy"!=b)b="lazy";var c=CH.cache("PH.loader");if(c[a]){var p=Object.keys(c[a]);if(0<p.length){var g=function(a,d){for(var b=0;b<p.length;b++){var e=p[b],c=k[e];(c.load&&c.load==a||"undefined"==typeof c.load&&"lazy"==a)&&"undefined"==typeof m[e]&&
f(e,null,!0)}},h=function(a,d,b){null==b&&(b=0);if(p.length>b){var e=p[b],c=k[e];(c.load&&c.load==a||"undefined"==typeof c.load&&"lazy"==a)&&"undefined"==typeof m[e]?f(e,function(){b++;h(a,d,b)}):(b++,h(a,d,b))}else d&&d()},k=c[a];e?g(b,d):h(b,d)}}else d&&d()}function f(a,b,d){var e=c(a);null!=e&&(d?(h(e,function(b){PH.fire("plugin-configuration-load-after",{pluginId:a,configuration:b})}),d=CH.cache("PH.roots")[a]+e["package"]+"/client/"+e.pluginPath+".js",U.loadjs(d,b)):h(e,function(d){PH.fire("plugin-configuration-load-after",
...
a[e]&&b.push(e)}for(d=0;d<b.length;d++)a=b[d],n[a]&&(a=n[a],e=a.indexOf(this.id),-1<e&&a.splice(e,1))}},removeFromLoader:function(){if(scope.events&&m[scope.id])for(var a=CH.cache("PH.loader"),b=0;b<scope.events.length;b++){var d=scope.events[b];a[d]&&(d=a[d],d[scope.id]&&delete d[scope.id])}},remove:function(){var a={plugin:this},b=this;PH.fire("plugin-remove-before",a,function(){(new Promise(function(d,e){PH.fire("plugin-remove-in-process",a);CH.cache("PH.roots")[b.id]&&delete CH.cache("PH.roots")[b.id];
